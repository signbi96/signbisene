...
<div class="tout">
            ...
            margin-top:5%;margin-left:-5%;margin-top:5%;">
                ...
                <a href="<?= WEB_ROUTE.'?Controller=Categorie&Views=add&id='.$id?>";>
                <input type="submit" value="Ajouter Une Categorie" class="btn btn-primary" 
                 style="width:100%;background:#002879; margin-top:-3%;margin-left:-23%"></a>

                 <?php if (!empty($datas)):?>

                <h5 style="color:#002879;margin-top:2%">Liste des Categories</h5>  
                <div class="filtre" style="margin-top:2%;margin-left:7%">
                  <form  action="<?= WEB_ROUTE ?>" method="GET" > 
                  <input class="sene" type="hidden" name="Controller" value="Categorie">
                  <input type="hidden" name="Views" value="Filtrer">
                  <label for=""></label>
                  <input type="text" value="" name="recherche" id="recherche" placeholder="search" 
                  style="width: 230px;height:35px;"></input>
                          ...
                          <table class="table table-hover" style="margin-top:1%">
                                    <thead>
                                      ...
                                      <tbody>
                                        ...
                                        <tr class="table">
                                          <th scope="row"><?= $data['idc']?></th>
                                          <td><?= $data['nomp']?></td>
                                          <td><?= $data['libellec']?></td>
                                          <td>
                                          <div class="action" style="display: flex;justify-content:space-around">
                                          <a href="<?= WEB_ROUTE.'?Controller=Categorie&Views=Modification&id='.$data['idc'] ?>">
                                          <i class="fas fa-solid fa-pen-to-square"></i></a>

                                          <a href="<?= WEB_ROUTE.'?Controller=Categorie&Views=Archiver&id='.$data['idc'] ?>"
                                          onclick="return confirm('etes vous sure de vouloir archiver cette projet ?')";>
                                          <i class="fas fa-archive" style="color:#002879"></i></a>

                                          <a href="<?= WEB_ROUTE.'?Controller=Tache&Views=add&id='.$data['idc'] ?>"
                                          onclick="return confirm('etes vous sure de vouloir ouvrir cette categorie ?')";>
                                          <input type="submit" value="Ajouter Tache" class="btn btn-primary" 
                                          style="width:100%;background:#002879;">
                                          </a>
                                          </div>
                                        </td>
                                          </tr>
                              ...
                              <div class="container">
                                         ...
                                         <?php for($i=1;$i<=$nombrepage;$i++):?>  
                                          ...
                                          <?php if($i == $page):?>
                                            ...
                                            <li class="page-item disabled">
                                              <a class="page-link" href="<?= WEB_ROUTE.'?Controller=Categorie&Views=lister&page='.$i?>"><?= $i ;?></a>
                                            </li>                          
                    
                                            <?php else:?>
                                              <li class="page-item active">
                                              <a class="page-link" style="background: #002879;" href="<?= WEB_ROUTE.'?Controller=Categorie&Views=lister&page='.$i?>"><?= $i ;?></a>
                                            </li>
                                ...
                                <?php else :?>
                                   <h4 style="text-align: center; margin-top:10%;margin-left:-60%">il y'a aucune categorie pour ce projet</h4>
                                  <?php endif ?>
    </div>
