...
<div class="tout">
            ...
            <div class="container" style="width:100%;margin-left:0%;">    
              ...
              <h4 style="color:#002879;margin-top:8%;margin-left:35%">Liste des rappelles</h4>   
                          <table class="table table-hover" style="margin-top:1%">
                                    <thead>
                                        <tr>
                                          <th scope="col">Id_user</th>
                                          <th scope="col">Rappelle</th>
                              ...
                              <div class="container">
                                         ...
                                         <?php for($i=1;$i<=$nombrepage;$i++):?>  
                                          ...
                                          <?php if($i == $page):?>
                                            ...
                                            <li class="page-item disabled">
                                              <a class="page-link"  href="<?= WEB_ROUTE.'?Controller=Equipe&Views=rappelle&page='.$i?>"><?= $i ;?></a>
                                            </li>                          
                    
                                            <?php else:?>
                                              <li class="page-item active">
                                              <a class="page-link" style="background: #002879;" href="<?= WEB_ROUTE.'?Controller=Equipe&Views=rappelle&page='.$i?>"><?= $i ;?></a>
                                            </li>
                               ...
                               <?php else :?>
                                   <h4 style="text-align: center; margin-top:10%;margin-left:-60%">il y'a aucune rappelle pour cet membre</h4>
                                  <?php endif ?>
            </div>
    </div>
